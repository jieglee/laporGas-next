  ...
  return (
    ...
    >
      <div className="flex items-center px-5 py-7 mb-2">
        <Link href="/user" className="flex items-center gap-2 no-underline">
          ...
          <span
            className={[
              textCls,
              "font-sans font-extrabold text-[1.15rem] tracking-[-0.02em] text-[#1a0e08]",
    ...
    return (
        ...
        >
            {/* Icon — badge hanya muncul saat collapsed */}
...
<span className={[textCls, "text-[0.92rem] tracking-[-0.01em]", active ? "font-bold text-[#E8541C]" : "font-medium text-[#3d2817]"].join(" ")}>
    {menu.name}
      ...
      <div className="border-t border-[#f5ede3] p-3 pb-[70px]">
        <div className="flex items-center gap-3 rounded-xl hover:bg-[#FAF5EF] transition-colors px-2 py-1.5 cursor-default">
          <div
            className={[
          ...
          <div
            className={[textCls, "flex flex-col gap-0.5", expanded ? "max-w-[140px]" : "max-w-0"].join(" ")}
          >
            ...
            <button
              ...
              className="text-[0.7rem] text-[#a8856b] bg-transparent border-none cursor-pointer p-0 flex items-center gap-1 transition-colors duration-200 hover:text-[#E8541C]"
            >
              <LogOut size={11} />
              Keluar
            </button>
