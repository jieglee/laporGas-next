...
import { useAdminNotif } from "@/hooks/UseAdminNotif";
...
export default function AdminSidebar() {
  ...
  const unreadNotif = useAdminNotif();
  ...
  return (
    <aside
      ...
      className={[
        ...
        expanded ? "w-[244px] shadow-[0_8px_32px_rgba(255,107,53,0.06)]" : "w-[72px] shadow-none",
      ].join(" ")}
    >
      {/* Logo */}
      <div className="flex items-center px-5 py-7 mb-2">
        <Link href="/admin" className="flex items-center gap-2 no-underline">
          <div className="flex items-center justify-center rounded-lg shrink-0 w-8 h-8">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" className="text-[#E8541C]">
          ...
          <span className={[
            textCls,
            "font-extrabold text-[1.15rem] tracking-[-0.02em] text-[#1a0e08] flex items-center gap-1.5",
          ].join(" ")}>
            ...
            >
              ...
              <div className="relative shrink-0">
                ...
                {isBell && unreadNotif > 0 && (
                  <span className="absolute -top-1.5 -right-1.5 min-w-[16px] h-4 px-[3px] rounded-full bg-[#E8541C] text-white text-[0.55rem] font-bold flex items-center justify-center leading-none">
              ...
              <span className={[
                ...
                {menu.name}
                {/* Hapus badge di sini — tidak ada lagi */}
              </span>
            </Link>
          );
        })}
      ...
      <div className="border-t border-[#f5ede3] p-3 pb-[70px]">
        <div className="flex items-center gap-3 rounded-xl py-1.5 px-2 transition-colors hover:bg-[#FAF5EF] cursor-default">
          <div className={[
            ...
            expanded ? "w-9 h-9 text-[0.78rem]" : "w-8 h-8 text-[0.72rem]",
          ].join(" ")}>
            {inisial}
          </div>
          ...
          <div className={[
            ...
            <button
              ...
              className="text-[0.7rem] text-[#a8856b] bg-transparent border-0 cursor-pointer p-0 flex items-center gap-1 hover:text-[#E8541C] transition-colors duration-200"
            >
              <LogOut size={11} />
              Keluar
            </button>
