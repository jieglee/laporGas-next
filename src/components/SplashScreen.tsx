                ...
                >
                    ...
                    {[380, 560].map((size) => (
                        <div
                            ...
                            style={{
                                width: size,
                                height: size,
                                border: `1px solid rgba(255,255,255,${size === 380 ? 0.12 : 0.07})`,
                                top: "50%",
                                left: "50%",
                            }}
                        />
                    ...
                    >
                        ...
                        <div className="text-center">
                            <h1 className="font-extrabold text-white m-0 leading-none tracking-[-0.03em]"
                                style={{ fontFamily: "'Syne', sans-serif", fontSize: "2.6rem" }}>
