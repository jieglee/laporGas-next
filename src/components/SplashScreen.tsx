  ...
  return (
    <AnimatePresence mode="wait" onExitComplete={onExitComplete}>
      {isVisible && (
        <motion.div
          key="splash"
          className="fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden bg-[#E8541C]"
          initial={{ y: 0 }}
          animate={{ y: 0 }}
          exit={{
            y: "-100%",
        ...
        >
          {[380, 560].map((size) => (
            <div
              ...
              className={cn(
                ...
                size === 380 ? "w-[380px] h-[380px] border-white/10" : "w-[560px] h-[560px] border-white/[0.07]"
              )}
            />
          ))}
          ...
          >
            <svg
              ...
              height="72"
              viewBox="0 0 24 24"
              className="text-white drop-shadow-[0_4px_16px_rgba(0,0,0,0.15)]"
            >
            ...
            <div className="text-center">
              <h1 className="font-sans font-extrabold text-white m-0 leading-none tracking-[-0.03em] text-[2.6rem]">
                Lapor<span className="text-white/45">Gas</span>
              </h1>
              <p className="text-[0.68rem] text-white/50 tracking-[0.18em] uppercase font-medium mt-3 mb-0">
